...
Example: 14, 25, 35, 9, 55', 'essential-addons-elementor' ),
		...
		//Tooltip
		$this->start_controls_section(
			'eael_fancy_chart_tooltip_setting',
			[
		...
		$this->add_control(
			'eael_fancy_chart_tooltip_enabel',
			[
				'label'        => esc_html__( 'Tooltip Enabel', 'essential-addons-elementor' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'essential-addons-elementor' ),
				'label_off'    => esc_html__( 'Hide', 'essential-addons-elementor' ),
				'return_value' => 'yes',
	...
	protected function get_chart_style_bar_options( $settings, $eael_dafault_data_attrs ) {
		...
		$horizontal_true = '';
		if ( 'horizontal' === $fancy_chart_settings['eael_fancy_chart_type'] ) {
		...
		$data_options = [
			...
			'plotOptions' => [
				'bar' => [
					...
					'columnWidth'  => $settings['eael_fancy_chart_bar_width']['size'],
				],
			],
			'stroke'      => [
			...
			'plotOptions' => [
				'radar' => [
					...
					'polygons' => [
						...
						'strokeWidth'  => 1,
						// 'connectorColors' => '#FFB6D9',
						// 'fill' => [
						//     'colors' => ['#FFC436', '#96C291'],
						// ],
					],
				],
			],
	...
	protected function get_fancy_chart_settings( $settings ) {
		...
		$fancy_chart_settings['eael_chart_style_tooltip_enabel']  = ! empty( $settings['eael_fancy_chart_tooltip_enabel'] ) ? $settings['eael_fancy_chart_tooltip_enabel'] : '';
