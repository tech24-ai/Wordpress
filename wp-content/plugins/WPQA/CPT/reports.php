...
function wpqa_report_custom_columns($column) {
	...
	switch ( $column ) {
		...
		case 'type' :
			...
			if ($report_type == "answer") {
				$report_type = esc_html_x("Answer","Admin report type","wpqa");
			}else if ($report_type == "user") {
				$report_type = esc_html_x("User","Admin report type","wpqa");
			}else {
				$report_type = esc_html_x("Question","Admin report type","wpqa");
			}
