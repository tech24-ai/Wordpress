	...
	class buddyboss_theme_Redux_Framework_config {
		...
		public function setSections() {
			...
			$style_elements = array(
				...
				/* Brand colors */
				array( 'slug' => 'brands_options_info', 'desc' => 'Brand Colors', 'type' => 'info' ),
                array( 'slug' => 'accent_color', 'title' => 'Primary color', 'subtitle' => 'Used for links, icons, buttons, highlights, and the mobile titlebar.', 'desc' => '', 'type' => 'color', 'default' => '#007CFF' ),
				array( 'slug' => 'accent_hover', 'title' => 'Secondary color', 'subtitle' => 'Used for various theme elements, hover links color and icons.', 'desc' => '', 'type' => 'color', 'default' => '#0F74E0' ),
				array( 'slug' => 'highlight_color', 'title' => 'Accent color', 'subtitle' => 'Used for various theme elements.', 'desc' => '', 'type' => 'color', 'default' => '#FE6F4B' ),
				/* Links */
				array( 'slug' => 'links_options_info', 'desc' => 'Link Colors', 'type' => 'info' ),
				...
				array( 'slug' => 'button_default_radius', 'title' => 'Button Border Radius', 'subtitle' => 'Change default button border radius.', 'desc' => '', 'type' => 'slider', 'default' => 100, 'min' => 0, 'step' => 1, 'max' => 100, 'display_value' => '100px' ),
				/* Text elements */
                ...
                /* Notices / Alerts */
                array( 'slug' => 'notice_color_info', 'desc' => 'Notices / Alerts', 'type' => 'info' ),
				array( 'slug' => 'default_notice_bg_color', 'title' => 'Default', 'subtitle' => 'Alert color for default notices', 'desc' => '', 'type' => 'color', 'default' => '#007CFF' ),
				array( 'slug' => 'info_notice_bg_color', 'title' => 'Loading', 'subtitle' => "Alert color for 'Loading' notices", 'desc' => '', 'type' => 'color', 'default' => '#f7ba45' ),
				array( 'slug' => 'success_notice_bg_color', 'title' => 'Success', 'subtitle' => "Alert color for 'Success' notices", 'desc' => '', 'type' => 'color', 'default' => '#1CD991' ),
				array( 'slug' => 'error_notice_bg_color', 'title' => 'Error', 'subtitle' => "Alert color for 'Error' notices", 'desc' => '', 'type' => 'color', 'default' => '#EF3E46' ),
				array( 'slug' => 'warning_notice_bg_color', 'title' => 'Warning', 'subtitle' => "Alert color for 'Warning' notices.", 'desc' => '', 'type' => 'color', 'default' => '#f7ba45' ),
				/* Login / Register Screens */
                array( 'slug' => 'admin_screen_info', 'desc' => 'Login / Register Screens', 'type' => 'info' ),
                array( 'slug' => 'admin_screen_bgr_color', 'title' => 'Login / Register Background Color', 'subtitle' => 'Background color for the page', 'desc' => '', 'type' => 'color', 'default' => '#FAFBFD' ),
                array( 'slug' => 'admin_screen_txt_color', 'title' => 'Login / Register Text Color', 'subtitle' => 'Text color used in form inputs', 'desc' => '', 'type' => 'color', 'default' => '#122B46' ),
                array( 'slug' => 'admin_screen_links_color', 'title' => 'Login / Register Links and Button Color', 'subtitle' => 'Links and buttons color', 'desc' => '', 'type' => 'color', 'default' => '#007CFF' ),
				array( 'slug' => 'admin_screen_links_hover_color', 'title' => 'Login / Register Links and Button Hover Color', 'subtitle' => 'Links and buttons color when hovered', 'desc' => '', 'type' => 'color', 'default' => '#0070e6' ),
			);
