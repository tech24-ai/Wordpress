...
class Widget_Adv120x240 extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ($show_ads == true) {
			...
			$adv_img_1  = (isset($instance['adv_img_1'])?esc_html(discy_image_url_id($instance['adv_img_1'])):'');
			...
			$adv_img_2  = (isset($instance['adv_img_2'])?esc_html(discy_image_url_id($instance['adv_img_2'])):'');
			...
			$adv_img_3  = (isset($instance['adv_img_3'])?esc_html(discy_image_url_id($instance['adv_img_3'])):'');
			...
			$adv_img_4  = (isset($instance['adv_img_4'])?esc_html(discy_image_url_id($instance['adv_img_4'])):'');
				...
				<div class="aalan-wrap">
					<div class="aalan aalan-4a-2">
						<?php if (has_wpqa() && wpqa_plugin_version >= "5.8") {
							echo wpqa_widget_ads($adv_type_1,$adv_type_1,$adv_href_1,$adv_img_1,$adv_code_1,'aalan-1').
							wpqa_widget_ads($adv_type_2,$adv_type_2,$adv_href_2,$adv_img_2,$adv_code_2,'aalan-1').
							wpqa_widget_ads($adv_type_3,$adv_type_3,$adv_href_3,$adv_img_3,$adv_code_3,'aalan-1').
							wpqa_widget_ads($adv_type_4,$adv_type_4,$adv_href_4,$adv_img_4,$adv_code_4,'aalan-1');
						}?>
					</div><!-- End aalan -->
