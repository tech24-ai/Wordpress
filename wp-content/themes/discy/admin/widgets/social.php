						...
						foreach ($sort_social as $key_r => $value_r) {$k++;
							...
							if (isset($sort_social[$key_r]["default"]) && $sort_social[$key_r]["default"] == "yes") {
								if ($sort_social_value != "rss") {
									if ($social_icon_h != "") {?>
										<li class="social-<?php echo esc_attr($sort_social_value)?>"><a title="<?php echo esc_attr($sort_social[$key_r]["name"])?>" href="<?php echo ($sort_social_value == "skype"?"skype:":"").($sort_social_value == "whatsapp"?"whatsapp://send?abid=":"").($sort_social_value != "skype" && $sort_social_value != "whatsapp"?esc_url($social_icon_h):$social_icon_h).($sort_social_value == "skype"?"?call":"").($sort_social_value == "whatsapp"?"&text=".esc_html__("Hello","discy"):"")?>"<?php echo ($sort_social_value != "skype" && $sort_social_value != "whatsapp"?" target='_blank'":"")?>><i class="icon-<?php echo esc_attr($sort_social[$key_r]["icon"] == "instagrem"?"instagram":$sort_social[$key_r]["icon"])?>"></i></a></li>
									<?php }
								}else {
									if ($rss_icon_h == "on") {
										...
										if ($rss_other != "") {?>
											<li class="social-<?php echo esc_attr($sort_social_value)?>"><a title="<?php esc_attr_e("Feed","discy")?>" href="<?php echo esc_url($rss_other)?>" target="_blank"><i class="icon-<?php echo esc_attr($sort_social[$key_r]["icon"])?>"></i></a></li>
										<?php }
									}
								}
							}else {
