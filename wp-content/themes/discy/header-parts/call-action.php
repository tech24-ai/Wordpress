			...
			<div class="the-main-container">
				<div class="call-action-wrap">
					...
					if ($show_action == true && $discy_signup_call_action == true) {
						...
						}else if ($action_button == "poll") {
							$filter_class = "question";
							$action_button_class = "wpqa-question";
							$action_button_link = (has_wpqa()?esc_url_raw(add_query_arg(array("type" => "poll"),wpqa_add_question_permalink())):"#");
							$action_button_text = esc_html__("Add A Poll","discy");
