		...
		<div class="quote">
			<blockquote>
				<div class="quote-inner">
					...
					<div class="post-inner-content"><p><?php echo esc_html($discy_quote_content);?></p></div>
					<?php if ($discy_quote_author != "") {?>
						<cite class="author">- <?php echo esc_html($discy_quote_author)?></cite>
					<?php }?>
				</div>
			</blockquote>
		</div><!-- End quote -->
...
<?php }else if ($what_post == "link") {?>
	<a <?php echo ($post_head_style)?> href="<?php echo esc_url($discy_link)?>" <?php echo ($discy_link_target == "style_2"?"target='_blank'":"")?> class="post-inner-link link">
		...
		<div class="post-link-inner">
			<?php echo esc_html($discy_link_title)?>
