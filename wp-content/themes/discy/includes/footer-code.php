					...
					if ($confirm_email != "yes" && $site_users_only != "yes") {
						...
						if (($site_style != "style_3" && $site_style != "style_4") || (($site_style == "style_3" || $site_style == "style_4") && ($sidebar_where == "sidebar" || $sidebar_where == "menu_sidebar"))) {
							$show_sidebar = true;
						}
						if (($sidebar_where == "menu_sidebar" || $sidebar_where == "sidebar") && isset($show_sidebar)) {?>
				...
				if (($site_style != "style_3" && $site_style != "style_4") || (($site_style == "style_3" || $site_style == "style_4") && $sidebar_where == "menu_left")) {
					$show_left_menu = true;
				}
				if (isset($show_left_menu) && $confirm_email != "yes" && $site_users_only != "yes" && ($tabs_menu === "on" || $sidebar_where == "menu_sidebar" || $sidebar_where == "menu_left")) {
